...
export default function TeacherAiUsagePage() {
  ...
  return (
    <div className="mx-auto max-w-[1280px] space-y-5 px-4 pb-10 pt-2 lg:px-6">
      ...
      {/* 聚合卡 */}
      <section>
        <h2 className="mb-2 text-[14px] font-semibold text-ink">按功能聚合（仅 succeeded）</h2>
        {loading ? (
      ...
      <section className="space-y-2">
        <header className="flex flex-wrap items-center justify-between gap-2">
          <h2 className="text-[14px] font-semibold text-ink">调用明细</h2>
